...
class InverseKinematics(Node):
    ...
    def __init__(self):
        ...
        base = 0.05
        touch_down_position = np.array([base, 0, -0.14])
        stand_position_1 = np.array([base/2, 0, -0.14])
        stand_position_2 = np.array([0, 0, -0.14])
        stand_position_3 = np.array([-base/2, 0, -0.14])
        liftoff_position = np.array([-base, 0, -0.14])
